<div class="prose max-w-[50ch]">
	<h1>Impressum</h1>
	<div>Angaben gemäß § 5 DDG</div>
	<div>Schlesier Str. 13 49356 Diepholz</div>
	<div>
		<p class="text-xl font-bold">Vertreten durch:</p>
		<p>Kim Malak</p>
		<p>Sebastian Lübbers</p>
	</div>
	<div>
		<p class="text-xl font-bold">Kontakt:</p>
		<p>
			Telefon: 01234-567891 Fax: 01234-567891:<a href="mailto:hallo@dh-campus.com"
				>hallo@dh-campus.com</a
			>
		</p>
	</div>
	<div>
		<p class="text-xl font-bold">Registereintrag:</p>
		<p>Eintragung im Registergericht: Diepholz Registernummer: 12345</p>
	</div>
	<div>
		<p class="text-xl font-bold">Umsatzsteuer-ID:</p>
		<p>Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: Musterustid.</p>
		<p class="text-xl font-bold">Wirtschafts-ID:</p>
		<p>Musterwirtschaftsid</p>
	</div>
	<div>
		<p class="text-xl font-bold">Aufsichtsbehörde:</p>
		<p>Aufsichtsbehörde Diepholz</p>
	</div>
	<div>
		<p class="text-xl font-bold">Haftungsausschluss:</p>
		<p class="text-xl font-bold">Haftung für Inhalte</p>
		<p>
		...
		<p class="text-xl font-bold">Haftung für Links</p>
		<p>
		...
		<p class="text-xl font-bold">Datenschutz</p>
		<p>
